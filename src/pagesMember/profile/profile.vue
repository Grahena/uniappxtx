...
import { getMyProfileApi, putMemberProfileApi } from '@/services/my';
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <input class="input" type="text" placeholder="请填写昵称" v-model="profileDetail.nickname" />
        </view>
        <view class="form-item">
        ...
        <view class="form-item">
          ...
          <picker @change="onchangData" class="picker" mode="date" start="1900-01-01" :end="new Date()"
        ...
        <view class="form-item">
          ...
          <picker @change="onchangeRegion" class="picker" mode="region"
        ...
        <view class="form-item">
          ...
          <input class="input" type="text" placeholder="请填写职业" v-model="profileDetail.profession" />
        </view>
      </view>
      <!-- 提交按钮 -->
      <button class="form-button" @tap="onchangeProfile">保 存</button>
    </view>
  </view>
</template>
