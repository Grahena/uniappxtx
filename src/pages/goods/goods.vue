...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item" v-for="(item, index) in goodsList?.details.properties" :key="item.name">
            <text class="label">{{ item.name }}</text>
            <text class="value">{{ item.value }}</text>
          </view>
        </view>
        <!-- 图片详情 -->
        <image mode="widthFix" v-for="(item, index) in goodsList?.details.pictures" :key="item" :src="item"></image>
      </view>
    </view>
    ...
    <view class="similar panel">
      ...
      <view class="content">
        <navigator v-for="item in goodsList?.similarProducts" :key="item.id" class="goods" hover-class="none"
